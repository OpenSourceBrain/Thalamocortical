...
numFRB =                3#50       #   full model: 50
numRS =                 6#1000     #   full model: 1000
numSupBask =            3#90       #   full model: 90
numSupAxAx =            3#90       #   full model: 90
numSupLTS =             3#90       #   full model: 90
numL4SpinStell =        3#240      #   full model: 240
numL5TuftIB =           3#800      #   full model: 800
numL5TuftRS =           3#200      #   full model: 200
numDeepBask =           3#100      #   full model: 100
numDeepAxAx =           3#100      #   full model: 100
numDeepLTS =            3#100      #   full model: 100
numL6NonTuftRS =        3#500      #   full model: 500
