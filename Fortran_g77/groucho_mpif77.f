...
c Define gap junction conductances.
       PARAMETER ( gapcon_suppyrRS  = 3.d-3 )
!      double precision, parameter :: gapcon_suppyrRS  = 0.d-3 ! to see if superf. lay. can follow 40 Hz
       PARAMETER ( gapcon_suppyrFRB = 3.d-3 )
!      double precision, parameter :: gapcon_suppyrFRB = 0.d-3 ! to see if superf. lay. can follow 40 Hz
       PARAMETER ( gapcon_supbask   = 1.d-3 )
       PARAMETER ( gapcon_supaxax   = 0.d-3 )
       PARAMETER ( gapcon_supLTS    = 1.d-3 )
       PARAMETER ( gapcon_spinstell = 3.d-3 )
!      double precision, parameter :: gapcon_spinstell = 0.d-3 ! to see if ctx follows 40 Hz from thal.
       PARAMETER ( gapcon_tuftIB    = 4.d-3 )
!      PARAMETER ( gapcon_tuftIB    = 0.d-3 ! to decr. antidr. bursting
       PARAMETER ( gapcon_tuftRS    = 4.d-3 )
!      PARAMETER ( gapcon_tuftRS    = 0.d-3 ! now follow 40 Hz?
       PARAMETER ( gapcon_nontuftRS = 4.d-3 )
!      PARAMETER ( gapcon_nontuftRS = 0.d-3 ) ! to abolish VFO in lay. 6
       PARAMETER ( gapcon_deepbask  = 1.d-3 )
       PARAMETER ( gapcon_deepaxax  = 0.d-3 )
       PARAMETER ( gapcon_deepLTS   = 1.d-3 )
!      PARAMETER ( gapcon_TCR       = 3.d-3 )
       PARAMETER ( gapcon_TCR       = 0.d-3 )
       PARAMETER ( gapcon_nRT       = 1.d-3 )


c Assorted parameters
         PARAMETER ( dt = 0.002d0 )
         PARAMETER ( Mg = 1.50 )
! Castro-Alamancos J Physiol, disinhib. neocortex in vitro, uses
! Mg = 1.3
         PARAMETER ( NMDA_saturation_fact
!    &                                   = 5.d0
     &                                   = 80.d0 )
...
c on that cell type...
       ...
       PARAMETER ( thal_cort_delay = 1.d0 )
       PARAMETER ( cort_thal_delay = 5.d0 )
...
! be changed to the same value:
       integer totaxgj_suppyrRS /722/
       integer totaxgj_suppyrFRB /722/
       integer totaxgj_suppyr /74/
       integer totSDgj_supbask /200/
       integer totSDgj_supaxax /0/
       integer totSDgj_supLTS    /200/
       integer totaxgj_spinstell /240/
       integer totaxgj_tuftIB    /350/
       integer totaxgj_tuftRS    /350/
!       integer totaxgj_tuft      /350/
       integer totaxgj_tuft       /10/
       integer totaxgj_nontuftRS /500/
       integer totSDgj_deepbask  /250/
       integer totSDgj_deepaxax   /0/
       integer totSDgj_deepLTS  /250/
       integer totaxgj_TCR       /100/
       integer totSDgj_nRT       /250/
       integer num_axgjcompallow_suppyrRS /1/
       integer num_axgjcompallow_suppyrFRB /1/
       integer num_SDgjcompallow_supbask  /8/
       integer num_SDgjcompallow_supLTS   /8/
       integer num_axgjcompallow_spinstell /1/
       integer num_axgjcompallow_tuftIB   /1/
       integer num_axgjcompallow_tuftRS   /1/
       integer num_axgjcompallow_nontuftRS /1/
       integer num_SDgjcompallow_deepbask /8/
       integer num_SDgjcompallow_deepLTS  /8/
       integer num_axgjcompallow_TCR      /1/
       integer num_SDgjcompallow_nRT  /8/
! how_often defines how many time steps between synaptic conductance
! updates, and between broadcastings of axonal voltages.
       PARAMETER ( axon_refrac_time = 1.5d0 )

c For these ectopic rate parameters, assume noisepe checked
c every 200 time steps = 0.4 ms = 1./2.5 ms
      PARAMETER ( noisepe_suppyrRS   =
!    &            1.d0 / (2.5d0 * 1000.d0) ! USUAL
     &            1.d0 / (2.5d0 * 10000.d0) )
      PARAMETER ( noisepe_suppyrFRB  =
!    &            1.d0 / (2.5d0 * 1000.d0) ! USUAL
     &            1.d0 / (2.5d0 * 10000.d0) )
      PARAMETER ( noisepe_spinstell  =
     &            1.d0 / (2.5d0 * 1000.d0) )
      PARAMETER ( noisepe_tuftIB     =
     &            1.d0 / (2.5d0 * 1000.d0) )
      PARAMETER ( noisepe_tuftRS     =
     &            1.d0 / (2.5d0 * 1000.d0) )
      PARAMETER ( noisepe_nontuftRS  =
     &            1.d0 / (2.5d0 * 1000.d0) )
      PARAMETER ( noisepe_TCR        =
     &            1.d0 / (2.5d0 * 1000.d0) )


c Synaptic conductance time constants. 
      PARAMETER ( tauAMPA_suppyrRS_to_suppyrRS=2.d0 )
      PARAMETER ( tauNMDA_suppyrRS_to_suppyrRS=130.5d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_suppyrFRB=2.d0 )
      PARAMETER ( tauNMDA_suppyrRS_to_suppyrFRB=130.d0  )
      PARAMETER ( tauAMPA_suppyrRS_to_supbask  =.8d0   )
      PARAMETER ( tauNMDA_suppyrRS_to_supbask  =100.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_supaxax  =.8d0  )
      PARAMETER ( tauNMDA_suppyrRS_to_supaxax  =100.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_supLTS   =1.d0  )
      PARAMETER ( tauNMDA_suppyrRS_to_supLTS   =100.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_spinstell=2.d0   )
      PARAMETER ( tauNMDA_suppyrRS_to_spinstell=130.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_tuftIB   =2.d0   )
      PARAMETER ( tauNMDA_suppyrRS_to_tuftIB   =130.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_tuftRS   =2.d0   )
      PARAMETER ( tauNMDA_suppyrRS_to_tuftRS   =130.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_deepbask =.8d0   )
      PARAMETER ( tauNMDA_suppyrRS_to_deepbask =100.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_deepaxax =.8d0   )
      PARAMETER ( tauNMDA_suppyrRS_to_deepaxax =100.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_deepLTS  =1.d0   )
      PARAMETER ( tauNMDA_suppyrRS_to_deepLTS  =100.d0 )
      PARAMETER ( tauAMPA_suppyrRS_to_nontuftRS=2.d0   )
      PARAMETER ( tauNMDA_suppyrRS_to_nontuftRS=130.d0 )

      PARAMETER ( tauAMPA_suppyrFRB_to_suppyrRS=2.d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_suppyrRS=130.d0  )
      PARAMETER ( tauAMPA_suppyrFRB_to_suppyrFRB=2.d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_suppyrFRB=130.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_supbask  =.8d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_supbask  =100.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_supaxax  =.8d0  )
      PARAMETER ( tauNMDA_suppyrFRB_to_supaxax  =100.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_supLTS   =1.d0  )
      PARAMETER ( tauNMDA_suppyrFRB_to_supLTS   =100.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_spinstell=2.d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_spinstell=130.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_tuftIB   =2.d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_tuftIB   =130.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_tuftRS   =2.d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_tuftRS   =130.d0)
      PARAMETER ( tauAMPA_suppyrFRB_to_deepbask =.8d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_deepbask =100.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_deepaxax =.8d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_deepaxax =100.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_deepLTS  =1.d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_deepLTS  =100.d0 )
      PARAMETER ( tauAMPA_suppyrFRB_to_nontuftRS=2.d0   )
      PARAMETER ( tauNMDA_suppyrFRB_to_nontuftRS=130.d0 )

      PARAMETER ( tauGABA_supbask_to_suppyrRS   =6.d0  )
      PARAMETER ( tauGABA_supbask_to_suppyrFRB  =6.d0  )
      PARAMETER ( tauGABA_supbask_to_supbask    =3.d0  )
      PARAMETER ( tauGABA_supbask_to_supaxax    =3.d0  )
      PARAMETER ( tauGABA_supbask_to_supLTS     =3.d0  )
      PARAMETER ( tauGABA_supbask_to_spinstell  =6.d0  )

      PARAMETER ( tauGABA_supaxax_to_suppyrRS   =6.d0  )
      PARAMETER ( tauGABA_supaxax_to_suppyrFRB  =6.d0  )
      PARAMETER ( tauGABA_supaxax_to_spinstell  =6.d0  )
      PARAMETER ( tauGABA_supaxax_to_tuftIB     =6.d0  )
      PARAMETER ( tauGABA_supaxax_to_tuftRS     =6.d0  )
      PARAMETER ( tauGABA_supaxax_to_nontuftRS  =6.d0  )

      PARAMETER ( tauGABA_supLTS_to_suppyrRS    =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_suppyrFRB   =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_supbask     =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_supaxax     =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_supLTS      =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_spinstell   =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_tuftIB      =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_tuftRS      =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_deepbask    =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_deepaxax    =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_deepLTS     =20.d0 )
      PARAMETER ( tauGABA_supLTS_to_nontuftRS   =20.d0  )

      PARAMETER ( tauAMPA_spinstell_to_suppyrRS =2.d0  )
      PARAMETER ( tauNMDA_spinstell_to_suppyrRS =130.d0 )
      PARAMETER ( tauAMPA_spinstell_to_suppyrFRB=2.d0  )
      PARAMETER ( tauNMDA_spinstell_to_suppyrFRB=130.d0 )
      PARAMETER ( tauAMPA_spinstell_to_supbask  =.8d0  )
      PARAMETER ( tauNMDA_spinstell_to_supbask  =100.d0)
      PARAMETER ( tauAMPA_spinstell_to_supaxax  =.8d0  )
      PARAMETER ( tauNMDA_spinstell_to_supaxax  =100.d0)
      PARAMETER ( tauAMPA_spinstell_to_supLTS   =1.d0  )
      PARAMETER ( tauNMDA_spinstell_to_supLTS   =100.d0)
      PARAMETER ( tauAMPA_spinstell_to_spinstell=2.d0  )
      PARAMETER ( tauNMDA_spinstell_to_spinstell=130.d0 )
      PARAMETER ( tauAMPA_spinstell_to_tuftIB   =2.d0  )
      PARAMETER ( tauNMDA_spinstell_to_tuftIB   =130.d0 )
      PARAMETER ( tauAMPA_spinstell_to_tuftRS   =2.d0  )
      PARAMETER ( tauNMDA_spinstell_to_tuftRS   =130.d0)
      PARAMETER ( tauAMPA_spinstell_to_deepbask =.8d0  )
      PARAMETER ( tauNMDA_spinstell_to_deepbask =100.d0)
      PARAMETER ( tauAMPA_spinstell_to_deepaxax =.8d0  )
      PARAMETER ( tauNMDA_spinstell_to_deepaxax =100.d0)
      PARAMETER ( tauAMPA_spinstell_to_deepLTS  =1.d0  )
      PARAMETER ( tauNMDA_spinstell_to_deepLTS  =100.d0)
      PARAMETER ( tauAMPA_spinstell_to_nontuftRS=2.d0  )
      PARAMETER ( tauNMDA_spinstell_to_nontuftRS=130.d0)

      PARAMETER ( tauAMPA_tuftIB_to_suppyrRS    =2.d0 )
      PARAMETER ( tauNMDA_tuftIB_to_suppyrRS    =130.d0)
      PARAMETER ( tauAMPA_tuftIB_to_suppyrFRB   =2.d0 )
      PARAMETER ( tauNMDA_tuftIB_to_suppyrFRB   =130.d0)
      PARAMETER ( tauAMPA_tuftIB_to_supbask     =.8d0  )
      PARAMETER ( tauNMDA_tuftIB_to_supbask     =100.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_supaxax     =.8d0  )
      PARAMETER ( tauNMDA_tuftIB_to_supaxax     =100.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_supLTS      =1.d0  )
      PARAMETER ( tauNMDA_tuftIB_to_supLTS      =100.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_spinstell   =2.d0   )
      PARAMETER ( tauNMDA_tuftIB_to_spinstell   =130.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_tuftIB      =2.d0  )
      PARAMETER ( tauNMDA_tuftIB_to_tuftIB      =130.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_tuftRS      =2.0d0 )
      PARAMETER ( tauNMDA_tuftIB_to_tuftRS      =130.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_deepbask    =.8d0  )
      PARAMETER ( tauNMDA_tuftIB_to_deepbask    =100.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_deepaxax    =.8d0  )
      PARAMETER ( tauNMDA_tuftIB_to_deepaxax    =100.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_deepLTS     =1.d0  )
      PARAMETER ( tauNMDA_tuftIB_to_deepLTS     =100.d0 )
      PARAMETER ( tauAMPA_tuftIB_to_nontuftRS   =2.0d0 )
      PARAMETER ( tauNMDA_tuftIB_to_nontuftRS   =130.d0 )

      PARAMETER ( tauAMPA_tuftRS_to_suppyrRS    =2.d0 )
      PARAMETER ( tauNMDA_tuftRS_to_suppyrRS    =130.d0)
      PARAMETER ( tauAMPA_tuftRS_to_suppyrFRB   =2.d0 )
      PARAMETER ( tauNMDA_tuftRS_to_suppyrFRB   =130.d0)
      PARAMETER ( tauAMPA_tuftRS_to_supbask     =.8d0  )
      PARAMETER ( tauNMDA_tuftRS_to_supbask     =100.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_supaxax     =.8d0  )
      PARAMETER ( tauNMDA_tuftRS_to_supaxax     =100.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_supLTS      =1.d0  )
      PARAMETER ( tauNMDA_tuftRS_to_supLTS      =100.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_spinstell   =2.d0  )
      PARAMETER ( tauNMDA_tuftRS_to_spinstell   =130.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_tuftIB      =2.d0  )
      PARAMETER ( tauNMDA_tuftRS_to_tuftIB      =130.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_tuftRS      =2.d0  )
      PARAMETER ( tauNMDA_tuftRS_to_tuftRS      =130.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_deepbask    =.8d0  )
      PARAMETER ( tauNMDA_tuftRS_to_deepbask    =100.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_deepaxax    =.8d0  )
      PARAMETER ( tauNMDA_tuftRS_to_deepaxax    =100.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_deepLTS     =1.d0   )
      PARAMETER ( tauNMDA_tuftRS_to_deepLTS     =100.d0 )
      PARAMETER ( tauAMPA_tuftRS_to_nontuftRS   =2.d0  )
      PARAMETER ( tauNMDA_tuftRS_to_nontuftRS   =130.d0 )

      PARAMETER ( tauGABA_deepbask_to_spinstell =6.d0  )
      PARAMETER ( tauGABA_deepbask_to_tuftIB    =6.d0  )
      PARAMETER ( tauGABA_deepbask_to_tuftRS    =6.d0  )
      PARAMETER ( tauGABA_deepbask_to_deepbask  =3.d0  )
      PARAMETER ( tauGABA_deepbask_to_deepaxax  =3.d0  )
      PARAMETER ( tauGABA_deepbask_to_deepLTS   =3.d0  )
      PARAMETER ( tauGABA_deepbask_to_nontuftRS =6.d0  )

      PARAMETER ( tauGABA_deepaxax_to_suppyrRS   =6.d0  )
      PARAMETER ( tauGABA_deepaxax_to_suppyrFRB  =6.d0  )
      PARAMETER ( tauGABA_deepaxax_to_spinstell  =6.d0  )
      PARAMETER ( tauGABA_deepaxax_to_tuftIB     =6.d0  )
      PARAMETER ( tauGABA_deepaxax_to_tuftRS     =6.d0  )
      PARAMETER ( tauGABA_deepaxax_to_nontuftRS  =6.d0  )

      PARAMETER ( tauGABA_deepLTS_to_suppyrRS    =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_suppyrFRB   =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_supbask     =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_supaxax     =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_supLTS      =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_spinstell   =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_tuftIB      =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_tuftRS      =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_deepbask    =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_deepaxax    =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_deepLTS     =20.d0 )
      PARAMETER ( tauGABA_deepLTS_to_nontuftRS   =20.d0 )

      PARAMETER ( tauAMPA_TCR_to_suppyrRS        =2.d0  )
      PARAMETER ( tauNMDA_TCR_to_suppyrRS        =130.d0)
      PARAMETER ( tauAMPA_TCR_to_suppyrFRB       =2.d0  )
      PARAMETER ( tauNMDA_TCR_to_suppyrFRB       =130.d0)
      PARAMETER ( tauAMPA_TCR_to_supbask         =1.d0  )
      PARAMETER ( tauNMDA_TCR_to_supbask         =100.d0)
      PARAMETER ( tauAMPA_TCR_to_supaxax         =1.d0  )
      PARAMETER ( tauNMDA_TCR_to_supaxax         =100.d0 )
      PARAMETER ( tauAMPA_TCR_to_spinstell       =2.0d0 )
      PARAMETER ( tauNMDA_TCR_to_spinstell       =130.d0)
      PARAMETER ( tauAMPA_TCR_to_tuftIB          =2.d0  )
      PARAMETER ( tauNMDA_TCR_to_tuftIB          =130.d0)
      PARAMETER ( tauAMPA_TCR_to_tuftRS          =2.d0  )
      PARAMETER ( tauNMDA_TCR_to_tuftRS          =130.d0)
      PARAMETER ( tauAMPA_TCR_to_deepbask        =1.d0  )
      PARAMETER ( tauNMDA_TCR_to_deepbask        =100.d0)
      PARAMETER ( tauAMPA_TCR_to_deepaxax        =1.d0  )
      PARAMETER ( tauNMDA_TCR_to_deepaxax        =100.d0)
      PARAMETER ( tauAMPA_TCR_to_nRT             =2.0d0      )
      PARAMETER ( tauNMDA_TCR_to_nRT             =150.d0)
      PARAMETER ( tauAMPA_TCR_to_nontuftRS       =2.0d0     )
      PARAMETER ( tauNMDA_TCR_to_nontuftRS       =130.d0)

!     PARAMETER ( tauGABA1_nRT_to_TCR             =10.d0 )
!     PARAMETER ( tauGABA2_nRT_to_TCR             =30.d0 )
!     PARAMETER ( tauGABA1_nRT_to_nRT             =18.d0 )
!     PARAMETER ( tauGABA2_nRT_to_nRT             =89.d0 )
! See notebook entry of 17 Feb. 2004.
! Speed these up per Huntsman & Huguenard (2000)
      PARAMETER ( tauGABA1_nRT_to_TCR             =3.30d0 )
      PARAMETER ( tauGABA2_nRT_to_TCR             =10.d0 )
      PARAMETER ( tauGABA1_nRT_to_nRT             = 9.d0 )
      PARAMETER ( tauGABA2_nRT_to_nRT             =44.5d0 )

      PARAMETER ( tauAMPA_nontuftRS_to_suppyrRS  =2.d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_suppyrRS  =130.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_suppyrFRB =2.d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_suppyrFRB =130.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_supbask   =.8d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_supbask   =100.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_supaxax   =.8d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_supaxax   =100.d0 )
      PARAMETER ( tauAMPA_nontuftRS_to_supLTS    =1.0d0 )
      PARAMETER ( tauNMDA_nontuftRS_to_supLTS    =100.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_spinstell =2.d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_spinstell =130.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_tuftIB    =2.d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_tuftIB    =130.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_tuftRS    =2.d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_tuftRS    =130.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_deepbask  =.8d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_deepbask  =100.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_deepaxax  =.8d0   )
      PARAMETER ( tauNMDA_nontuftRS_to_deepaxax  =100.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_deepLTS   =1.d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_deepLTS   =100.d0)
      PARAMETER ( tauAMPA_nontuftRS_to_TCR       =2.d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_TCR       =130.d0 )
      PARAMETER ( tauAMPA_nontuftRS_to_nRT       =2.0d0 )
      PARAMETER ( tauNMDA_nontuftRS_to_nRT       =100.d0 )
      PARAMETER ( tauAMPA_nontuftRS_to_nontuftRS =2.d0  )
      PARAMETER ( tauNMDA_nontuftRS_to_nontuftRS =130.d0 )
...
!          call mpi_comm_size(mpi_comm_world, nodes , info)
          call mpi_init ()
          call mpi_comm_rank(mpi_comm_world, thisno)
          call mpi_comm_size(mpi_comm_world, nodes)
...
!     &    mpi_double_precision, 7, mpi_comm_world, info)
     ...
     &    mpi_double_precision, 0, mpi_comm_world)
      call mpi_bcast (vax_suppyrFRB ,num_suppyrFRB,
     &    mpi_double_precision, 1, mpi_comm_world)
      call mpi_bcast (vax_tuftIB    ,num_tuftIB  ,
     &    mpi_double_precision, 6, mpi_comm_world)
      call mpi_bcast (vax_tuftRS    ,num_tuftRS   ,
     &    mpi_double_precision, 7, mpi_comm_world)
