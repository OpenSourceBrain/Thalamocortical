...
c for proportions, see /home/traub/supergj/tests.f
        PARAMETER (totaxgj_suppyrRS =  722)
        PARAMETER (totaxgj_suppyrFRB =   4 )
        PARAMETER (totaxgj_suppyr    =  74 )
! totaxgj_suppyr = number of "mixed" gj between RS suppyr
! (1st col. of table) and FRB suppyr (3rd col. of table) cells
        PARAMETER (totSDgj_supbask   = 200 )
        PARAMETER (totSDgj_supaxax   =   0 )
        PARAMETER (totSDgj_supLTS    = 200 )
        PARAMETER (totaxgj_spinstell = 240 )
        PARAMETER (totaxgj_tuftIB    = 350 )
        PARAMETER (totaxgj_tuftRS    = 350 )
!        PARAMETER (totaxgj_tuft      = 350 )
        PARAMETER (totaxgj_tuft      =  10 )  ! decr. antidr. bursts in IB
! totaxgj_tuft for mixed gj between tuftIB (1st) and tuftRS (next)
        PARAMETER (totaxgj_nontuftRS = 500 )
        PARAMETER (totSDgj_deepbask  = 250 )
        PARAMETER (totSDgj_deepaxax  =   0 )
        PARAMETER (totSDgj_deepLTS   = 250 )
        PARAMETER (totaxgj_TCR       = 100  )
        PARAMETER (totSDgj_nRT       = 250)
c Note: no gj between axoaxonic cells.

c Define number of compartments on a cell where a gj might form
        PARAMETER (num_axgjcompallow_suppyrRS = 1)
        PARAMETER (num_axgjcompallow_suppyrFRB= 1)
        PARAMETER (num_SDgjcompallow_supbask  = 8)
        PARAMETER (num_SDgjcompallow_supLTS   = 8)
        PARAMETER (num_axgjcompallow_spinstell= 1)
        PARAMETER (num_axgjcompallow_tuftIB   = 1)
        PARAMETER (num_axgjcompallow_tuftRS   = 1)
        PARAMETER (num_axgjcompallow_nontuftRS= 1)
        PARAMETER (num_SDgjcompallow_deepbask = 8)
        PARAMETER (num_SDgjcompallow_deepLTS  = 8)
        PARAMETER (num_axgjcompallow_TCR      = 1)
        PARAMETER (num_SDgjcompallow_nRT      = 8)
