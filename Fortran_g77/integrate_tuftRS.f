...
c rectifier (ar).
        SUBROUTINE integrate_tuftRS (O, time, numcell, V, curr,
...
c numcomp = number of compartments, including 6 in the axon.
     ...
     &   gjtable_mix (totaxgj_mix,4)
       ...
       REAL*8 Z, Z1, Z2, Z3,curr(numcomp_p,numcell),c(numcomp_p)
...
! z1, z2, z3 as per layVtup.f.2Jun03
           z1 = 0.2d0
           z2 = 3.6d0
           z3 = 0.4d0
           do i = 1, 55
...
!        gkc_dens = 0.25d0
        ...
        gkc_dens(0) = 0.d0 ! matches Appendix A but not same as modeldb traub
         gkc_dens(1) =  8.00d0
         gkc_dens(2) =  8.00d0
         gkc_dens(5) =  8.00d0
         gkc_dens(6) =  8.00d0
