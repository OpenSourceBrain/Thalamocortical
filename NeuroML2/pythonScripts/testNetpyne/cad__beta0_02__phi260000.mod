TITLE Mod file for component: Component(id=cad__beta0_02__phi260000 type=fixedFactorConcentrationModelTraub)
...
NEURON {
    SUFFIX cad__beta0_02__phi260000
...
PARAMETER {
    ...
    restingConc = 0 (mM)
    beta = 0.020000001 (kHz)
    phi = 2.5999999E16 (mM m2 /A /s)
}
