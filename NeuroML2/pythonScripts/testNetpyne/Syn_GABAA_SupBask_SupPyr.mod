TITLE Mod file for component: Component(id=Syn_GABAA_SupBask_SupPyr type=expOneSynapse)
...
NET_RECEIVE(weight) {
    ?state_discontinuity(g, g  + (weight *   gbase  )) : From Syn_GABAA_SupBask_SupPyr
    g = g  + (weight *   gbase  ) : From Syn_GABAA_SupBask_SupPyr
