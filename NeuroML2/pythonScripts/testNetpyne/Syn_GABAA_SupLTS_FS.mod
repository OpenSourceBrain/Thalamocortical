TITLE Mod file for component: Component(id=Syn_GABAA_SupLTS_FS type=expOneSynapse)
...
NET_RECEIVE(weight) {
    ?state_discontinuity(g, g  + (weight *   gbase  )) : From Syn_GABAA_SupLTS_FS
    g = g  + (weight *   gbase  ) : From Syn_GABAA_SupLTS_FS
