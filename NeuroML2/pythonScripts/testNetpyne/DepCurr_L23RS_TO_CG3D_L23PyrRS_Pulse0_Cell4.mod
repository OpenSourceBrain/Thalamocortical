TITLE Mod file for component: Component(id=DepCurr_L23RS_TO_CG3D_L23PyrRS_Pulse0_Cell4 type=pulseGenerator)
...
NEURON {
    POINT_PROCESS DepCurr_L23RS_TO_CG3D_L23PyrRS_Pulse0_Cell4
    ELECTRODE_CURRENT i
