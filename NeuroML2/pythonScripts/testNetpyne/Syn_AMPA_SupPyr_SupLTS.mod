TITLE Mod file for component: Component(id=Syn_AMPA_SupPyr_SupLTS type=alphaSynapse)
...
NET_RECEIVE(weight) {
    ?state_discontinuity(A, A  + (  gbase  *weight)) : From Syn_AMPA_SupPyr_SupLTS
    A = A  + (  gbase  *weight) : From Syn_AMPA_SupPyr_SupLTS
