TITLE Mod file for component: Component(id=naf__a0__b0__c0__d0__fastNa_shiftmin3_5 type=ionChannelHH)
...
NEURON {
    SUFFIX naf__a0__b0__c0__d0__fastNa_shiftmin3_5
...
PARAMETER {
    ...
    m_steadyState_fastNa_shift = -3.5 
    m_steadyState_a = 0 
    m_steadyState_b = 0 
    m_steadyState_c = 0 
    m_steadyState_d = 0 
    ...
    h_steadyState_fastNa_shift = -3.5 
    h_steadyState_a = 0 
    h_steadyState_b = 0 
    h_steadyState_c = 0 
    h_steadyState_d = 0 
...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: conductanceScaling[*]/factor, on: Component(id=naf__a0__b0__c0__d0__fastNa_shiftmin3_5 type=ionChannelHH), from conductanceScaling; null
    ? Path not present in component, using factor: 1
    
    conductanceScale = 1 
    
    ? DerivedVariable is based on path: gates[*]/fcond, on: Component(id=naf__a0__b0__c0__d0__fastNa_shiftmin3_5 type=ionChannelHH), from gates; Component(id=m type=gateHHtauInf)
...
PROCEDURE rates() {
    ...
    if (( m_timeCourse_V  +  m_timeCourse_fastNa_shift )  < ( -30 ))  { 
        ...
        m_timeCourse_t = ( 0.02 +  m_timeCourse_a  + (0.145 +  m_timeCourse_b ) * ( exp ( -1 * (( m_timeCourse_V  +  m_timeCourse_fastNa_shift  +  m_timeCourse_d ) + 30) / (10.0 +  m_timeCourse_c )) )) *  m_timeCourse_TIME_SCALE ? evaluable cdv
    }
    ...
    ? DerivedVariable is based on path: steadyState/x, on: Component(id=m type=gateHHtauInf), from steadyState; Component(id=null type=naf__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5_m_inf_inf)
    m_inf = m_steadyState_x ? path based
    
    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=m type=gateHHtauInf), from timeCourse; Component(id=null type=naf__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5_m_tau_tau)
    ...
    h_steadyState_x = 1 / ( 1 + (exp (( (  h_steadyState_V  +  h_steadyState_fastNa_shift  * 0 ) + 62.9 ) / 10.7)) ) ? evaluable
    h_timeCourse_V = v /  h_timeCourse_VOLT_SCALE ? evaluable
    h_timeCourse_t = (0.15 + 1.15 / ( 1 + ( exp (( (  h_timeCourse_V  +  h_timeCourse_fastNa_shift  * 0 ) + 37 ) / 15) ) )) *  h_timeCourse_TIME_SCALE ? evaluable
    ...
    ? DerivedVariable is based on path: steadyState/x, on: Component(id=h type=gateHHtauInf), from steadyState; Component(id=null type=naf__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5_h_inf_inf)
    h_inf = h_steadyState_x ? path based
    
    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=h type=gateHHtauInf), from timeCourse; Component(id=null type=naf__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5__a0__b0__c0__d0__fastNa_shiftmin3_5_h_tau_tau)
