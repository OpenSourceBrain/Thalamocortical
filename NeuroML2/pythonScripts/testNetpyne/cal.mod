...
PARAMETER {
    ...
    m_forwardRate_scale = 13.888889 (mV)
...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: gates[*]/fcond, on: Component(id=cal type=ionChannelHH), from gates; Component(id=m type=gateHHrates)
