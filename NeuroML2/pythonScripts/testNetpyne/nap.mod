...
PROCEDURE rates() {
    ...
    if (m_timeCourse_V   < ( -40 ))  { 
        m_timeCourse_t = ( 0.025 + 0.14 * (exp ((  m_timeCourse_V  + 40 )/10)) ) *  m_timeCourse_TIME_SCALE ? evaluable cdv
    } else  { 
        m_timeCourse_t = ( 0.02 + 0.145 * (exp (-1 * ( m_timeCourse_V  + 40)/ 10))) *  m_timeCourse_TIME_SCALE ? evaluable cdv
    }
    ...
    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=m type=gateHHtauInf), from timeCourse; Component(id=null type=nap_m_tau_tau)
