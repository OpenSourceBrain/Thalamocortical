TITLE Mod file for component: Component(id=cad__beta0_01__phi26000 type=fixedFactorConcentrationModelTraub)
...
NEURON {
    SUFFIX cad__beta0_01__phi26000
