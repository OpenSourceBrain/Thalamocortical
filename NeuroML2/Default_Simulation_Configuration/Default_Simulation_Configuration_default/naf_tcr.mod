...
NEURON {
    ...
    RANGE m_timeCourse_shift_mnaf_init      : parameter
    RANGE m_timeCourse_shift_mnaf_run       : parameter
    RANGE m_timeCourse_shift_hnaf           : parameter
    
    RANGE m_timeCourse_t                    : exposure
    RANGE m_steadyState_TIME_SCALE          : parameter
    RANGE m_steadyState_VOLT_SCALE          : parameter
    RANGE m_steadyState_shift_mnaf_init     : parameter
    RANGE m_steadyState_shift_mnaf_run      : parameter
    RANGE m_steadyState_shift_hnaf          : parameter
    ...
    RANGE h_timeCourse_shift_mnaf_init      : parameter
    RANGE h_timeCourse_shift_mnaf_run       : parameter
    RANGE h_timeCourse_shift_hnaf           : parameter
    
    RANGE h_timeCourse_t                    : exposure
    RANGE h_steadyState_TIME_SCALE          : parameter
    RANGE h_steadyState_VOLT_SCALE          : parameter
    RANGE h_steadyState_shift_mnaf_init     : parameter
    RANGE h_steadyState_shift_mnaf_run      : parameter
    RANGE h_steadyState_shift_hnaf          : parameter
...
PARAMETER {
    ...
    m_timeCourse_shift_mnaf_init = -3 
    m_timeCourse_shift_mnaf_run = -2.5 
    m_timeCourse_shift_hnaf = -7 
    m_steadyState_TIME_SCALE = 1 (ms)
    m_steadyState_VOLT_SCALE = 1 (mV)
    m_steadyState_shift_mnaf_init = -3 
    m_steadyState_shift_mnaf_run = -2.5 
    m_steadyState_shift_hnaf = -7 
    h_instances = 1 
    h_timeCourse_TIME_SCALE = 1 (ms)
    h_timeCourse_VOLT_SCALE = 1 (mV)
    h_timeCourse_shift_mnaf_init = -3 
    h_timeCourse_shift_mnaf_run = -2.5 
    h_timeCourse_shift_hnaf = -7 
    h_steadyState_TIME_SCALE = 1 (ms)
    h_steadyState_VOLT_SCALE = 1 (mV)
    h_steadyState_shift_mnaf_init = -3 
    h_steadyState_shift_mnaf_run = -2.5 
    h_steadyState_shift_hnaf = -7 
}
...
PROCEDURE rates() {
    ...
    if ((  m_timeCourse_V  +  m_timeCourse_shift_mnaf_init  +  m_timeCourse_shift_mnaf_run  )  < ( -30 ))  { 
        m_timeCourse_t = ( 0.025 + 0.14 * ( exp ( (( m_timeCourse_V  +  m_timeCourse_shift_mnaf_init  +  m_timeCourse_shift_mnaf_run ) + 30) / 10) ) ) *  m_timeCourse_TIME_SCALE ? evaluable cdv
    } else  { 
        m_timeCourse_t = ( 0.02 + (0.145) * ( exp ( -1 * (( m_timeCourse_V  +  m_timeCourse_shift_mnaf_init  +  m_timeCourse_shift_mnaf_run ) + 30) / 10) )) *  m_timeCourse_TIME_SCALE ? evaluable cdv
    }
    
    m_steadyState_V = v /  m_steadyState_VOLT_SCALE ? evaluable
    m_steadyState_x = 1 / ( 1 + (exp ( ( -1 * ( m_steadyState_V  +  m_steadyState_shift_mnaf_init  +  m_steadyState_shift_mnaf_run ) - 38) / 10)) ) ? evaluable
    ...
    h_steadyState_x = 1 / ( 1 + (exp (( (  h_steadyState_V  +  h_steadyState_shift_hnaf  ) + 62.9 ) / 10.7)) ) ? evaluable
